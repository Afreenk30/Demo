...
public class App {
	...
	static Scanner sn = new Scanner(System.in); 
 	...
 	public static void info() { 
        ...
        String developerName = "Dev – Afreen Karikatti\n"; 
 	 	 
 	 	String developerEmail = "DevEmail – afreenkr2000@gmail.com\n"; 
 	...
 	public static void main() { 
 	 	...
 	 	int choice = sn.nextInt();  	 	handle(choice); 
 	} 
 	public static void handle(int num) {  	 	switch(num) {  	 	 	case 1: 
 	 	 	 	Ascending.ascendingOrder();  	 	 	 	break;  	 	 	case 2: 
